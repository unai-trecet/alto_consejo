...
ActiveRecord::Schema[7.1].define(version: 2024_01_07_182828) do
  ...
  create_table "match_invitations", force: :cascade do |t|
    ...
    t.index ["user_id", "match_id"], name: "index_match_invitations_on_user_id_and_match_id", unique: true
  ...
  create_table "match_participants", force: :cascade do |t|
    ...
    t.index ["user_id", "match_id"], name: "index_match_participants_on_user_id_and_match_id", unique: true
