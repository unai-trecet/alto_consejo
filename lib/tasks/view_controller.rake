  ...
  namespace :stimulus_manifest do
    ...
    task update: :environment do
      ...
      File.open(Rails.root.join('app/javascript/controllers/index.js'), 'w+') do |index|
        index.puts '// This file is auto-generated by ./bin/rails view_controller:stimulus_manifest:update'
        index.puts '// Run that command whenever you add a new controller in ViewConstroller'
        index.puts
